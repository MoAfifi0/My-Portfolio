        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              who loves solving problems and building Back-end Websites.
              <br />
              ...
              <i className="primary-header">Node.js</i> and Modern Python
              Library and Framework like
              <i className="primary-header"> Django.</i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links" data-aos="fade-up">
              <li className="social-icons">
                <a
                  href="https://github.com/MoAfifi0"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/afifi000"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="twitter"
              ...
              <li className="social-icons">
                <a
                  href="mailto:m.afifi00000@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="email"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/mohammed-alafif/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/m.afifi000/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
